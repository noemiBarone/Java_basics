...
public class Main {
    ...
    private static void exercise1() {
        ...
        number = number + 2;
        ourNumberStr = String.valueOf(number);
    ...
    private static void exercise2() {
        ...
        //charAt() trova l'indice di un carattere di una stringa
    ...
    private static void exercise3() {
        ...
        String doubleStrToConvert = "6.78"; // Also this line
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4:");
        String startStr = "5";
        int number = Integer.valueOf(startStr);
        number = number * 2;
        startStr = String.valueOf(number);
        startStr = startStr + startStr;
        System.out.println(startStr);
        double ourNumber = Double.valueOf(startStr);
        ourNumber = ourNumber / 3.5;
        System.out.println(Math.floor(ourNumber));
