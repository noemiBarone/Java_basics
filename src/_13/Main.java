...
public class Main {
    ...
    private static void exercise2() {
        ...
        System.out.println("Il minimo e': "+ minNumber + ". Il massimo è: " + maxNumber + ".");
    }
    ...
    private static void exercise4() {
        int number = 8;
        for (int timesTableCurrentValue = 0; timesTableCurrentValue <= number * 10; timesTableCurrentValue += number) {
    ...
    private static void exercise5() {
        for (int timesTableNumber = 1; timesTableNumber <= 10; timesTableNumber++) {
            System.out.println("*********** Multiplication tables number " + timesTableNumber + " ****************");
            for (int timesTableCurrentValue = 0; timesTableCurrentValue <= timesTableNumber * 10; timesTableCurrentValue+= timesTableNumber){
                System.out.print(timesTableCurrentValue + " ");
