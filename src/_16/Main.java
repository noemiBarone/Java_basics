...
public class Main {
     ...
     *    2c: Money in a hedgefund in euros --> long (possono esserci valori molto alti)
     ...
     *    2f: The number of kilometers from any 2 places in the world --> short (la distanza massima è 32_000)
     */
